...
export default function About() {
    ...
    return (
        <div id="about" className="relative w-4/5 py-10 m-auto mt-16 text-center -z-10 scroll-mt-20 ">
            <p className="text-slate-800 dark:text-white">Introduction</p>
            <h1 className="text-4xl text-slate-800 dark:text-white">About me</h1>
            <div className="flex flex-col items-center gap-10 mt-4 md:flex-row">
                ...
                <div className="w-[700px] flex flex-col items-center gap-3">
                    ...
                    <div className="pl-2 md:mr-auto">
                        <p className="my-3 text-center md:text-start dark:text-white text-slate-600">Tools i use</p>
